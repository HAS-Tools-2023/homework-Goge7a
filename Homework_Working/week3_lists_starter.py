...
print(min(flow))
print(max(flow))
print(np.nanmean(flow))
print(np.nanstd(flow))
...
#ilist2 = [i for i in range(len(flow)) if flow[i] > 600 and month[i]==9]
#print(len(ilist2))
